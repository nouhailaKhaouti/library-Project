    ...
    <div class="d-flex justify-content-around align-item-center">
        ...
        <section class="pt-5 pb-5">
            <div class="container d-flex justify-content-center align-item-center">
                <a href="#carouselExampleIndicators2" class="mt-5 pt-5 d-none d-sm-block" role="button" data-slide="prev">
                ...
                <div class="row">
                    <div class="col-12 text-center d-flex justify-content-around">
                        ...
                        <img class="position-absolute end-0 left d-none d-sm-block " src="image/arrow.png" alt="left-arrow">
                    </div>
                    <div class="col-12">
                ...
                <a href="#carouselExampleIndicators2" class="mt-5 pt-5 d-none d-sm-block" role="button" data-slide="next">
