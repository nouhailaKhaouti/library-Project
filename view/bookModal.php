                    ...
                    <form action="./php/user.php" method="POST" id="second" class="d-flex justify-content-between pe-5" enctype='multipart/form-data' >
                        ...
                        <div class="fw-bold">
                            ...
                            <div id="hidden_img">
                                ...
                                title: &nbsp; &nbsp;
                                <input class="form-control input-sm m-1 cart shadow-sm" type="text" name="title" id="title" placeholder="enter your userName" required>
                                ...
                                <div class="nowrap">
                                    ...
                                    <input class="form-control input-sm m-1 cart shadow-sm" type="text" name="autor" id="autor" placeholder="enter your email address" required>
                                    <i class="fas fa-check-circle"></i>
                                    <i class="fas fa-exclamation-circle"></i>
                                    <small>Error message</small>
                                </div>
                                ...
                                <div class="nowrap"> <label for="isbi"> Isbi:</label>
                                    <input class="form-control input-sm m-1 cart shadow-sm" type="number" name="isbi" placeholder="re-enter your password to comfirme" id="isbi" required>
                                    <i class="fas fa-check-circle"></i>
                                    <i class="fas fa-exclamation-circle"></i>
                                    <small>Error message</small>
                                </div>
                                ...
                                <div class="nowrap"> <label for="image"> Image:</label>
                                    <input class="form-control input-sm m-1 cart shadow-sm" type="file" name="image"  id="image">
                                    <i class="fas fa-check-circle"></i>
                                    <i class="fas fa-exclamation-circle"></i>
                                    <small>Error message</small>
                                </div>
                                <div class="nowrap"> <label for="date"> published:</label>
                                    <input class="form-control input-sm m-1 cart shadow-sm" type="date" name="date" id="date" required>
                                    <i class="fas fa-check-circle"></i>
                                    <i class="fas fa-exclamation-circle"></i>
                                    <small>Error message</small>
                                </div>
                                <div class="nowrap"> <label for="page"> Number of pages:</label>
                                    <input class="form-control input-sm m-1 cart shadow-sm" type="number" name="page" id="page" required>
                                    <i class="fas fa-check-circle"></i>
                                    <i class="fas fa-exclamation-circle"></i>
                                    <small>Error message</small>
                                </div>
                                ...
                                <label for="description" class="d-block">description:</label>
									<textarea class="form-control input-sm m-1 cart shadow-sm" id="description" name="description" rows="5" cols="33">description...</textarea>
                                </div>
                                </br>
